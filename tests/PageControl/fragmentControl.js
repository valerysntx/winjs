...
WinJSTests.FragmentControl = function () {
    ...
    this.testExternalJSCSS = function(complete) {
        ...
        then(function (docfrag) {
            ...
            return WinJS.Promise.timeout(300).then(function() {
    ...
    this.testEventOrdering = function (complete) {
        var fragfile = "foo";
        WinJS.UI.Pages._remove(fragfile);
    ...
    this.testErrorOrdering = function (complete) {
        var options = { stage: 0 };
        var fragfile = "foo";
        var stageError = 45;
        var err = -1;
    ...
    this.testDisposePageControl = function(complete) {
        ...
        WinJS.UI.Pages.render(fragfile).then(function (page) {
            ...
            WinJS.UI.Pages.render(fragfile).then(function (page2) {
